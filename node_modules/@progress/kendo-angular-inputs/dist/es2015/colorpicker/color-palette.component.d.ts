 ...
 */
export declare class ColorPaletteComponent implements OnInit, OnChanges, ControlValueAccessor {
    private service;
    /**
    ...
    constructor(service: ColorPaletteService);
    ngOnInit(): void;
    ...
    reset(): void;
    private setRows();
    private handleCellNavigation(horizontalStep, verticalStep);
    private handleEnter();
}
