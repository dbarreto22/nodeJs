...
/**
 * Fires when the active color indicator of the ColorPicker wrapper is clicked.
 *
...
var ColorPickerComponent = /** @class */ (function () {
    function ColorPickerComponent(popupService) {
        ...
        this.onBlur = new EventEmitter();
        /**
         * Fires each time the ColorPicker active color is clicked.
         *
     ...
     * @hidden
     */
    ColorPickerComponent.prototype.handleActiveColorClick = function (originalEvent) {
        this.focus();
    ...
    ColorPickerComponent.decorators = [
        { type: Component, args: [{
                    ...
                    providers: [{ multi: true, provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(function () { return ColorPickerComponent; }) }],
...
var ColorPaletteComponent = /** @class */ (function () {
    ...
    ColorPaletteComponent.decorators = [
        { type: Component, args: [{
                    ...
                    providers: [
                        { multi: true, provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(function () { return ColorPaletteComponent; }) },
                        ColorPaletteService
                    ],
...
var ColorGradientComponent = /** @class */ (function () {
    function ColorGradientComponent(host, ngZone, renderer) {
        this.host = host;
        this.ngZone = ngZone;
        this.renderer = renderer;
        this.hostClasses = true;
    ...
    Object.defineProperty(ColorGradientComponent.prototype, "alphaSliderValue", {
         ...
         */
        get: function () {
            return isPresent(this.hsva) && isPresent(this.hsva.a) ? this.hsva.a * 100 : 100;
        },
        enumerable: true,
        configurable: true
    });
    ...
    ColorGradientComponent.prototype.ngOnInit = function () {
        if ([this.hsva.h, this.hsva.s, this.hsva.v, this.hsva.a].some(function (value) { return !isPresent(value); })) {
            this.updateUI();
        }
    };
