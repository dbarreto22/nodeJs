...
class ColorPickerComponent {
    ...
    get format() {
        const alphaChannelUsed = this.view === 'gradient' && this.gradientSettings.opacity;
     ...
     * @hidden
     */
    handleActiveColorClick(originalEvent) {
        this.focus();
...
ColorPickerComponent.decorators = [
    { type: Component, args: [{
                ...
                providers: [{ multi: true, provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => ColorPickerComponent) }],
                template: `
        <span
            #wrapper
            [ngClass]="{
...
/** @nocollapse */
ColorPaletteService.ctorParameters = () => [];

// tslint:disable:member-ordering
// tslint:disable:no-output-rename
const DEFAULT_TILE_SIZE = 24;
const DEFAULT_COLUMNS_COUNT = 10;
const DEFAULT_PRESET_NAME = 'office';
/**
...
ColorPaletteComponent.decorators = [
    { type: Component, args: [{
                ...
                providers: [
                    { multi: true, provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => ColorPaletteComponent) },
                    ColorPaletteService
                ],
                template: `
        <div role="grid">
...
class ColorGradientComponent {
    ...
    ngOnInit() {
        if ([this.hsva.h, this.hsva.s, this.hsva.v, this.hsva.a].some(value => !isPresent(value))) {
            this.updateUI();
        }
    }
    ngAfterViewInit() {
