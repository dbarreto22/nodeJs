...
var ColorGradientComponent = /** @class */ (function () {
    ...
    Object.defineProperty(ColorGradientComponent.prototype, "value", {
        get: function () {
            return this._value || utils_1.parseColor(DEFAULT_SELECTED_COLOR, this.format);
        },
        /**
    ...
    Object.defineProperty(ColorGradientComponent.prototype, "isFocused", {
         ...
         */
        get: function () {
            if (!utils_2.isPresent(this.host)) {
                return false;
            }
    ...
    Object.defineProperty(ColorGradientComponent.prototype, "alphaSliderValue", {
         ...
         */
        get: function () {
            return utils_2.isPresent(this.hsva) && utils_2.isPresent(this.hsva.a) ? this.hsva.a * 100 : 100;
        },
        enumerable: true,
        configurable: true
    });
    ...
    ColorGradientComponent.prototype.ngOnInit = function () {
        if ([this.hsva.h, this.hsva.s, this.hsva.v, this.hsva.a].some(function (value) { return !utils_2.isPresent(value); })) {
            this.updateUI();
        }
    };
    ...
    ColorGradientComponent.prototype.updateUI = function () {
        this.hsva = utils_1.getHSV(this.value);
