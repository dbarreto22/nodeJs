...
class ScrollSyncService {
    constructor(ngZone, localization) {
        ...
        this.subscriptions.add(this.changes.pipe(distinctUntilChanged$1((x, y) => x.scrollLeft === y.scrollLeft))
            .subscribe(this.scrollLeft.bind(this)));
        this.subscriptions.add(this.localization.changes.pipe(skip$1(1), tap$1(() => {
            this.elements.forEach(item => item.element.scrollLeft = -1);
        }), switchMap$1(() => this.ngZone.onStable.asObservable().pipe(take$1(1)))).subscribe(() => {
...
class ScrollerService {
    ...
    create(rowHeightService, skip$$1, take$$1, total) {
        ...
        const subject = new BehaviorSubject$1(new ScrollAction(this.rowHeightService.offset(skip$$1)));
...
class FilterInputDirective {
    ...
    subscribeChanges() {
        this.changeRequestsSubscription = this.changeRequests
            .pipe(debounceTime$1(this.filterDelay), filter$1(() => !this.composing))
